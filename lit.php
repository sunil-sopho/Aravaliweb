...
?>
<?php renderHeader(array('title' => 'LITERARY','page' => 'brca')); ?>
 ...
 <div class="collection">
		...
		<a href="#!"  class="collection-item active center-align"><img src="images/lit.jpg" alt="" class="circle left" width="20px" height="20px">Literary Club</a>
  ...
  <div class="card" style="width:400px;height:500px">
    <div class="card-image waves-effect waves-block waves-light">
      <img class="activator" src="images/clubs/literary/litrep.jpg" width="200px" height="400px">
    </div>
    <div class="card-content">
      <span class="card-title activator grey-text text-darken-4">LITERARY REPRESENTATIVE<i class="material-icons right">more_vert</i></span>
      <p><a href="#">AAKASH AGARWAL</a></p>
    </div>
    <div class="card-reveal">
      <span class="card-title grey-text text-darken-4">Aakash Agarwal<i class="material-icons right">close</i></span>
  ...
  <ul class="collapsible" data-collapsible="accordion">
    <li>
      <div class="collapsible-header "><i class="material-icons">play_arrow</i>Harilal Krishna</div>
      <div class="row collapsible-body"><img src="images/clubs/literary/hari.jpg" alt="" class="col s4" width="100px" height="100px"><p>Enthusiast in debating</p></div>
    </li>
    <li>
      <div class="collapsible-header"><i class="material-icons">play_arrow</i>Dev Tiwari</div>
      <div class="row collapsible-body"><img src="images/clubs/literary/dev.jpg" alt="" class="col s4" width="100px" height="100px" ><p>Enthusiast in debating</p></div>
    </li>
