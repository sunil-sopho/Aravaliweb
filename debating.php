...
?>
<?php renderHeader(array('title' => 'DEBATING','page' => 'brca')); ?> 
 ...
 <div class="collection">
		...
		<a href="#!"  class="collection-item active center-align"><img src="images/debating.jpg" alt="" class="circle left" width="20px" height="20px">Debating Club</a>
  ...
  <div class="card" style="width:400px;height:400px">
    <div class="card-image waves-effect waves-block waves-light">
      <img class="activator" src="images/clubs/debating/debatingrep.jpg" width="200px">
    </div>
    <div class="card-content">
      <span class="card-title activator grey-text text-darken-4">DEBATING REPRESENTATIVE<i class="material-icons right">more_vert</i></span>
      <p><a href="#">KAUSTUBH SAXENA</a></p>
    </div>
    <div class="card-reveal">
      <span class="card-title grey-text text-darken-4">Kaustubh Saxena<i class="material-icons right">close</i></span>
