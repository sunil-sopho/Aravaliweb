...
?>
<?php renderHeader(array('title' => 'HINDI SAMITI','page' => 'brca')); ?>
 ...
 <div class="collection">
		...
		<a href="#!"  class="collection-item active center-align"><img src="images/hindi.jpg" alt="" class="circle left" width="20px" height="20px">Hindi Samiti</a>
  ...
  <div class="card" style="width:400px;height:500px">
    <div class="card-image waves-effect waves-block waves-light">
      <img class="activator" src="images/clubs/hindi/hindirep.jpg" width="200px">
    </div>
    <div class="card-content">
      <span class="card-title activator grey-text text-darken-4">HIMDI SAMITI REPRESENTATIVE<i class="material-icons right">more_vert</i></span>
      <p><a href="#">CHINMAY SINGH</a></p>
    </div>
    <div class="card-reveal">
      <span class="card-title grey-text text-darken-4">Chinmay Singh<i class="material-icons right">close</i></span>
  ...
  <ul class="collapsible" data-collapsible="accordion">
    <li>
      ...
      <div class="row collapsible-body"><img src="images/clubs/hindi/dev.jpg" alt="" class="col s4" width="100px" height="100px"><p>Enthusiast in debating</p></div>
    </li>
    <li>
      <div class="collapsible-header"><i class="material-icons">play_arrow</i>Tarun Gupta</div>
      <div class="row collapsible-body"><img src="images/clubs/hindi/tarun.jpg" alt="" class="col s4" width="100px" height="100px" ><p>Enthusiast in debating</p></div>
    </li>
    		  </ul>
